...
def run_deepeval_comparison():
    ...
    results_path = results_dir / "error_explanation_results.json"
    ...
    # Define metric - only AnswerRelevancyMetric
    ...
    for explanation_result in error_explanations:
        ...
        # Calculate results for single case - only answer relevancy
        try:
            relevancy_score = relevancy_metric.measure(test_case)
        except Exception as e:
            print(f"Error when calculating relevancy: {e}")
            relevancy_score = 0.5  # Default value in case of error
    ...
    # Execute evaluation as a dataset
    try:
    ...
    print(f"\nAverage answer relevancy: {avg_relevancy:.4f}")
